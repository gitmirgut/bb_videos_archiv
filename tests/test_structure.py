...
@pytest.fixture
def dts_2016(config):
    return structure.Directory_Tree_Structure('/home/mrpoin/Beesbook/bb_videos_iterator/tests/'
                                              'data/in/videos_proxy', '2016')


@pytest.fixture
def dts_2015(config):
    return structure.Directory_Tree_Structure('/home/mrpoin/Beesbook/bb_videos_iterator/tests/'
                                              'data/in/videos_proxy', '2015')


def test_load_default():
    dts = structure.Directory_Tree_Structure('/home/mrpoin/Beesbook/bb_videos_iterator/tests/'
                                             'data/in/videos_proxy', '2016')
...
def test_path_for_dt_cam(dts_2015, dts_2016):
    ...
    assert path_dir == "/home/mrpoin/Beesbook/bb_videos_iterator/tests/data/in/" \
                       "videos_proxy/2016-09-02/Cam_0"
    ts = iso8601.parse_date("2015-09-02")
    cam_id = 2
    path_dir = dts_2015._path_for_dt_cam(ts, cam_id, abs=True)
    assert path_dir == "/home/mrpoin/Beesbook/bb_videos_iterator/tests/data/in/videos_proxy/" \
                       "20150902/Cam_2"
    bad_cam_id = 666
...
def test_find(dts_2016):
    ...
    assert videos == ['/home/mrpoin/Beesbook/bb_videos_iterator/tests/data/in/videos_proxy/'
                      '2016-08-05/Cam_0/'
                      'Cam_0_2016-08-05T00:04:22.402199Z--2016-08-05T00:10:02.251240Z.mkv']
